...
export const WorldMapModal: React.FC<WorldMapModalProps> = ({ player, onClose }) => {
  const pRatioX = (player.x / WORLD_WIDTH) * 100;
  const pRatioY = (player.y / WORLD_HEIGHT) * 100;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 font-sans">
      ...
      >
        ...
        <div className="pb-3 border-b border-black/5">
          ...
          <p className="text-xs text-gray-600 font-medium">Forest Campsite, Mountain Foothills, Outlaw Canyon & Welder's Summit</p>
        </div>
        ...
        <div className="relative w-full aspect-[16/10] bg-[#1a222d] rounded-[28px] border-2 border-white/20 mt-4 overflow-hidden shadow-inner text-white">
          ...
          <div className="absolute inset-0 grid grid-cols-2 grid-rows-2">
            {/* Top-Left: Survivor Forest Campsite */}
            <div className="border-r border-b border-white/10 bg-emerald-950/40 p-4 relative">
            ...
            {/* Top-Right: Rocky Mountain Canyon */}
            <div className="border-b border-white/10 bg-slate-900/60 p-4 relative">
            ...
            {/* Bottom-Left: Dense Pine Woods */}
            <div className="border-r border-white/10 bg-emerald-950/60 p-4 relative">
            ...
            {/* Bottom-Right: Welder's Summit Arena */}
            <div className="bg-rose-950/50 p-4 relative">
